      ...
      <div className="mx-auto max-w-3xl">
        ...
        <div className="prose prose-gray max-w-none">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-lg font-medium text-gray-800 mb-3">3.1 Registration</h3>
            <p className="text-base text-gray-700 leading-relaxed mb-4">
            ...
            <h3 className="text-lg font-medium text-gray-800 mb-3">3.2 Account Termination</h3>
            <p className="text-base text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            ...
            <p className="text-base text-gray-700 leading-relaxed mb-4">You agree not to:</p>
            <ul className="list-disc list-inside text-base text-gray-700 space-y-2 mb-4">
              <li>Submit false, misleading, or fraudulent information</li>
              <li>Submit content that is illegal, harmful, threatening, abusive, or violates any laws</li>
              <li>Submit content that infringes on intellectual property rights</li>
              <li>Submit spam, unsolicited promotional content, or engage in any form of automated data collection</li>
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">5. Content Ownership and License</h2>
            ...
            <h3 className="text-lg font-medium text-gray-800 mb-3">5.2 Our Content</h3>
            <p className="text-base text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">6. Product Submissions</h2>
            <p className="text-base text-gray-700 leading-relaxed mb-4">
              When you submit a product to the Service, you represent and warrant that:
            </p>
            <ul className="list-disc list-inside text-base text-gray-700 space-y-2 mb-4">
              <li>You have the right to submit the product and all associated content</li>
              <li>The product and content do not infringe on any third-party rights</li>
              <li>The information provided is accurate and not misleading</li>
              <li>You are authorized to represent the product or have permission from the product owner</li>
            </ul>
            <p className="text-base text-gray-700 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">7. Moderation and Content Removal</h2>
            <p className="text-base text-gray-700 leading-relaxed mb-4">
