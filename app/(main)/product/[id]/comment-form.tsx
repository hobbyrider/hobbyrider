    ...
    <form onSubmit={handleSubmit} className="space-y-3 sm:space-y-4 min-w-0">
      <div className="min-w-0">
        <textarea
          ...
          rows={4}
          className="w-full rounded-xl border-2 border-gray-200 px-3 sm:px-4 py-2.5 sm:py-3 text-sm resize-none focus:border-black focus:outline-none transition min-w-0"
          required
          disabled={submitting}
        />
      </div>
      <div className="flex justify-end min-w-0">
        <button
          ...
          className="rounded-lg bg-black text-white px-5 sm:px-6 py-2 sm:py-2.5 text-sm font-semibold hover:bg-gray-800 transition disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap flex-shrink-0"
        >
