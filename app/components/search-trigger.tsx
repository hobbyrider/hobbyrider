  ...
  return (
    <>
      <button
        ...
        className="inline-flex items-center justify-center sm:justify-start gap-2 sm:gap-3 rounded-lg border border-border bg-background p-2 sm:px-3 sm:px-4 sm:py-2 sm:py-2.5 hover:border-input focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring transition-colors flex-shrink-0"
      ...
      >
        ...
        <span className="text-sm sm:text-base text-muted-foreground hidden sm:inline">Search products...</span>
      </button>
