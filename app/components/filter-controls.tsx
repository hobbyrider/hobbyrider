...
export function FilterControls() {
  ...
  return (
    <>
      ...
      {/* Sort Options */}
      <div>
        <label className="text-xs sm:text-sm font-medium text-foreground mb-2 block" id="sort-label">
          Rank by
        </label>
          ...
          {sortOptions.map((option) => {
            ...
            return (
              <Link
                ...
                className={cn(
                  "px-2.5 sm:px-3 py-1.5 rounded-lg text-xs sm:text-sm font-medium border transition-colors duration-200 whitespace-nowrap flex-shrink-0 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring",
                  isActive
                    ? "bg-primary text-primary-foreground border-primary"
                    : "bg-background text-foreground border-border hover:bg-accent hover:border-input"
                )}
      ...
      {/* Date Filter */}
      <div>
        <label className="text-xs sm:text-sm font-medium text-foreground mb-2 block" id="date-label">
          Time range
        </label>
      ...
      {hasActiveFilters && (
        <div>
          <Link
            ...
            className="inline-flex items-center gap-1.5 text-sm text-muted-foreground transition-colors hover:text-foreground focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-ring rounded"
          >
            <svg
