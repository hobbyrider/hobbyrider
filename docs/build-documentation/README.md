# Hobbyrider Build Documentation

This folder contains all documentation related to the Hobbyrider build, architecture, and development guide.

## 📁 Files in this folder

### Main Documentation
- **`HOBBYRIDER_BUILD.md`** - Complete build book (original large file - currently empty, was too large for Git)
...
**For navigation:** Start with [`00-INDEX.md`](00-INDEX.md) - it has links to all sections

**For a complete overview:** The original file was split due to Git size limits. Use the numbered files above.
...
All build documentation is now centralized in:
```
docs/build-documentation/
```

This makes it easy to find all build-related documentation in one place.
